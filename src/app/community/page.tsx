    ...
    <div className="space-y-6">
      ...
      <section className="card border-track-orange/25 bg-track-orange/10">
        <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
          <div>
            <div className="pill mb-3">Official contact</div>
            <h2 className="text-2xl font-black">Contact the creator team</h2>
            <p className="mt-2 text-track-muted">Support, partnerships, feedback, sponsorship and community questions.</p>
          </div>
